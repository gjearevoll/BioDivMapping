...
#' 
#' 
processFreshwaterFishInventory <- function(focalEndpoint, tempFolderName, datasetName, regionGeometry, 
  ...
  # Need to remove all absence data for certain species
  eventTableWithOccurrences <- eventTableWithOccurrences[!(eventTableWithOccurrences$species %in% c("Phoxinus phoxinus", "Cottus gobio", "Cottus poecilopus",
                                                                                                  "Gasterosteus aculeatus") & eventTableWithOccurrences$individualCount == 0),]
